...
echo mogenerator --model \"${INPUT_FILE_PATH}\" --output-dir \"${PROJECT_DIR}/SightSee/Classes/Models\" --template-var arc=true
mogenerator --model "${INPUT_FILE_PATH}" --output-dir "${PROJECT_DIR}/SightSee/Classes/Models" --template-var arc=true
